...
ingredient_images = {
    ...
    "きのこ": os.path.join(image_base_path, "mushroom.png"),
    "エッグ": os.path.join(image_base_path, "egg.png"),
    "ポテト": os.path.join(image_base_path, "potato.png"),
    "りんご": os.path.join(image_base_path, "apple.png"),
    "ハーブ": os.path.join(image_base_path, "herb.png"),
    "マメミート": os.path.join(image_base_path, "meat.png"),
    "ミルク": os.path.join(image_base_path, "milk.png"),
    "ミツ": os.path.join(image_base_path, "honey.png"),
    "オイル": os.path.join(image_base_path, "oil.png"),
    "ジンジャー": os.path.join(image_base_path, "ginger.png"),
    "トマト": os.path.join(image_base_path, "tomato.png"),
    "カカオ": os.path.join(image_base_path, "cacao.png"),
    "シッポ": os.path.join(image_base_path, "tail.png"),
    "大豆": os.path.join(image_base_path, "soybeans.png"),
    "コーン": os.path.join(image_base_path, "corn.png"),
    "コーヒー": os.path.join(image_base_path, "coffee.png"),
}
